...
export type AdminOrderPdv = { id: string; name: string };
          ...
          <tbody>
            {rows.map((o) => (
              ...
              >
                ...
                <td className="mono px-4 py-2 text-palantir-muted">{o.items}</td>
            ...
            {rows.length === 0 && (
              <tr>
                <td
                  colSpan={8}
                  className="px-4 py-6 text-center text-sm text-palantir-muted"
                >
          ...
          >
            ...
            <div className="mt-2 grid grid-cols-3 gap-2 text-[11px]">
              <div>
                ...
                <p className="mono text-palantir-text">{o.items}</p>
              </div>
              <div>
