...
export function CustomerHeader({
  ...
  return (
    <div className="sticky top-0 z-30 bg-somma-bg/95 backdrop-blur border-b border-somma-border px-5 py-2 flex items-center justify-between">
      ...
      <button
        onClick={logout}
        disabled={loading}
        className="num text-[10px] uppercase text-somma-muted hover:text-somma-orange disabled:opacity-50"
      >
        {loading ? "..." : "Sair"}
      </button>
    </div>
